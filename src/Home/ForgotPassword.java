...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("GARDIAN'S NAME");
        ...
        jLabel1.setText("Reset Password Using Email Address");
	...
	String p1 = jPasswordField3.getText();
        String p2 = jPasswordField4.getText();
	if (p1.equals(p2)) {
            if ("s123".equals(id) && "dinesha".equals(name) && "abcdef".equals(email)) {
	...
	l2.show();
        ...
        dispose();
            ...
            JOptionPane.showInternalMessageDialog(null,"Please enter correct details");
        }
        }else{
            JOptionPane.showInternalMessageDialog(null,"Passwords are not matched");       
        }
