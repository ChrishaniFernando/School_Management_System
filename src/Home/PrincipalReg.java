 ...
 * @author acer
 */
public class PrincipalReg extends javax.swing.JFrame {

    /**
     * Creates new form PrincipalReg
     */
    public PrincipalReg() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalReg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalReg().setVisible(true);
            }
        });
    }
